...
CREATE TYPE "public"."audit_action" AS ENUM('project_created', 'project_trashed', 'project_restored', 'project_purged', 'brief_submitted', 'persona_selected', 'source_uploaded', 'source_deleted', 'nda_acknowledged', 'fact_check_approved', 'human_review_approved', 'human_review_revised', 'critique_selected', 'export_requested', 'agent_job_dispatched', 'agent_response_received', 'agent_job_failed', 'stage_started', 'stage_completed', 'stage_failed', 'version_created', 'version_sealed');--> statement-breakpoint
CREATE TABLE "users" (
